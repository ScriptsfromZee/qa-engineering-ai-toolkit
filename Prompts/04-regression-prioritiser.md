...
7. **OPTIONAL MODIFIERS:** (add any to the end of your prompt to make it more specific to you/ your product):

- "We have [X] hours, give me the minimum viable regression set" *(replace X with your actual time)*
